...
from load_docs import document_load_pdf, document_load_csv
...
def main():
    st.set_page_config(page_title="Chat CSV Ollama ChromaDB", layout="wide")

    # Sidebar
    with st.sidebar:
        st.title("ChatBot")
        st.info("Welcome to Chat CSV Ollama ChromaDB! Upload CSVs, ask questions, and explore document content interactively.")
    ...
    st.write("Upload a CSV file and interact with its content using AI-powered responses.")

    # File upload section
    uploaded_file = st.file_uploader("Upload a CSV", type=["pdf", "csv"], help="Upload your CSV file here to begin.")
    ...
    if uploaded_file is not None:
        ...
        document_load_csv(CHROME_DB, file_name)
    ...
    st.write("Enter your question below to chat with the content of your uploaded CSV.")
